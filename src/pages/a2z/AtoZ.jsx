    ...
    <div className="max-w-[1260px] mx-auto px-[15px] flex flex-col mt-[64px] max-md:mt-[50px]">
      <ul className="flex gap-x-2 mt-[50px] items-center w-fit max-[1200px]:hidden">
        <li className="flex gap-x-3 items-center">
          <Link to="/home" className="text-white hover:text-[#39d353] text-[17px] transition-colors">
            Home
          </Link>
      ...
      <div className="flex flex-col gap-y-5 mt-6">
        <h1 className="font-bold text-2xl text-[#39d353] max-[478px]:text-[18px]">
          Sort By Letters
        </h1>
          ...
          {[
            ...
            return (
              <Link
                to={`/az-list/${linkPath}`}
                key={index}
                className={`text-md bg-[#1a1a1a] border border-white/10 py-1 px-4 rounded-md font-bold hover:text-black hover:bg-[#39d353] hover:border-[#39d353] hover:cursor-pointer transition-all ease-out ${
                  isActive ? "text-black bg-[#39d353] border-[#39d353]" : ""
                }`}
              >
                {item}
              </Link>
