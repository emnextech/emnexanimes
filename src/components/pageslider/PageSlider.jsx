    ...
    const renderPageNumbers = () => {
        ...
        return pages.map((p) => (
            <button
                ...
                className={`w-[40px] text-[15px] mx-1 flex justify-center items-center p-2 rounded-full font-bold ${page === p ? 'bg-[#39d353] text-black cursor-default' : 'bg-[#1a1a1a] text-gray-500 hover:text-[#39d353]'} ${start ? "bg-[#1a1a1a]" : "bg-[#1a1a1a]"} `}
            >
                {p}
            </button>
        ));
            ...
            <div className="flex justify-center mt-4 w-fit">
                {page > 1 && totalPages > 2 && (
                    <button
                        ...
                        className={`w-[40px] mx-1 p-2 bg-[#1a1a1a] rounded-full text-gray-500 text-[8px] hover:text-[#39d353]`}
                    >
