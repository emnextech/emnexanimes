...
const logo = `<p style="display: flex; gap: 7px; align-items: center; background-color:#111111; padding:5px;padding-inline:7px; border-radius:5px">
    <b style="color: #39d353;">Powered by</b>
    <span style="font-size: 14px;">
        emnex<span style="color: #39d353;">animes</span>
    </span>
</p>
`;
